    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Google Sign-in */}
          {showDirectGoogle ? (
            <form onSubmit={handleDirectGoogleSubmit} className="mt-3 p-3.5 bg-blue-50/70 border border-blue-200 rounded-xl space-y-2.5 text-left">
              <div className="flex items-center justify-between pb-1 border-b border-blue-100">
                <span className="text-xs font-bold text-blue-900 flex items-center gap-1.5">
                  ...
                  <span>เข้าสู่ระบบด้วยบัญชี Google Email</span>
                </span>
                <button
                  type="button"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="name@gmail.com หรือ teacher@school.ac.th"
                  className="w-full px-2.5 py-1.5 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 focus:outline-none focus:border-blue-500"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-2 px-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer mt-1"
              >
                {isSubmitting ? (
            ...
            <div className="space-y-1.5 mt-2">
              <button
                ...
                disabled={loading}
                className="w-full py-2 px-3 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-xl text-xs transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xs"
              >
